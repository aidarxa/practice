...
inline void BlockLoad(const Acc &acc, size_t tid, int tile_offset, int (&items)[ITEMS_PER_THREAD],int num_items) 
{
    if(BLOCK_THREADS * ITEMS_PER_THREAD == num_items){
        BlockLoadDirect<Acc,BLOCK_THREADS,ITEMS_PER_THREAD>(
